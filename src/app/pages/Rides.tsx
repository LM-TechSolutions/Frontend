    ...
    <div className="p-6">
          ...
          <TableBody>
            {filteredRides.map((ride) => (
              <TableRow key={ride.id} className="hover:bg-[#F9FAFB]">
                ...
                <TableCell>
                  <div>
                    <p className="font-medium text-[#111827]">{ride.customerName}</p>
                    <p className="text-xs text-[#6B7280]">{ride.customerPhone}</p>
                  </div>
                </TableCell>
                <TableCell className="max-w-[200px]">
                  <p className="text-sm text-[#6B7280] truncate">{ride.pickupLocation}</p>
                </TableCell>
                <TableCell className="max-w-[200px]">
                  <p className="text-sm text-[#6B7280] truncate">{ride.dropoffLocation}</p>
                </TableCell>
                <TableCell>
                  {ride.driverName ? (
                    <p className="text-sm text-[#111827]">{ride.driverName}</p>
                  ) : (
                    <p className="text-sm text-[#6B7280] italic">Not assigned</p>
                  )}
                </TableCell>
                <TableCell>
      ...
      <div className="mt-6 flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button variant="outline" size="sm" className="bg-[#00BDC3] text-white hover:bg-[#009EA3]">
            1
          </Button>
