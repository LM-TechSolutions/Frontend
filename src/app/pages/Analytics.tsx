...
export default function Analytics() {
  ...
  const metrics = [
    { label: 'Total Rides', value: stats.totalRides ?? 0, icon: Car, color: '#00BDC3' },
    { label: 'Total Revenue', value: formatETB(stats.totalRevenue), icon: DollarSign, color: '#10B981' },
    { label: 'Active Drivers', value: `${stats.activeDrivers ?? 0}/${stats.totalDrivers ?? 0}`, icon: Users, color: '#00BDC3' },
    { label: 'Total Calls', value: stats.totalCalls ?? 0, icon: PhoneCall, color: '#00BDC3' },
  ];
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <Card>
        <CardHeader><CardTitle className="text-lg">Operator Performance</CardTitle></CardHeader>
        <CardContent>
