            ...
            <DialogContent className="sm:max-w-[500px]">
              ...
              <div className="space-y-3 py-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-2"><Label>Phone *</Label><Input value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })} placeholder="0911…" /></div>
                  <div className="space-y-2"><Label>Email *</Label><Input value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} placeholder="driver@…" /></div>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="space-y-2"><Label>Vehicle Model</Label><Input value={form.vehicleModel} onChange={(e) => setForm({ ...form, vehicleModel: e.target.value })} placeholder="Toyota Corolla" /></div>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-2"><Label>License Plate *</Label><Input value={form.licensePlate} onChange={(e) => setForm({ ...form, licensePlate: e.target.value })} placeholder="AA-12345" /></div>
                  <div className="space-y-2"><Label>License Number *</Label><Input value={form.licenseNumber} onChange={(e) => setForm({ ...form, licenseNumber: e.target.value })} placeholder="DL-…" /></div>
                </div>
      ...
      <Dialog open={!!editing} onOpenChange={(o) => !o && setEditing(null)}>
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="space-y-3 py-4">
            ...
            <div className="space-y-2"><Label>Vehicle Model</Label><Input value={edit.vehicleModel} onChange={(e) => setEdit({ ...edit, vehicleModel: e.target.value })} /></div>
            <div className="space-y-2"><Label>License Plate</Label><Input value={edit.licensePlate} onChange={(e) => setEdit({ ...edit, licensePlate: e.target.value })} /></div>
